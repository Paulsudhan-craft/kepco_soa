...
class ReceivablePayableReport:
	...
	def get_invoice_details(self):
		...
		if self.account_type == "Receivable":
			...
			for d in si_list:
				self.invoice_details.setdefault(d.name, { "due_date": d.due_date,
                "po_no": d.po_no})

			
			# frappe.log_error(self.invoice_details, "Invoice Details Debug")
	...
	def get_columns(self):
		...
		self.add_column(label=_("Customer PO Number"), fieldname="remarks", fieldtype="Text", width=200)
